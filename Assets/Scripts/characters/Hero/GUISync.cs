...
public class GUISync : MonoBehaviour {
	...
	void Update () 
	{
		...
		ShieldSlider.sliderValue = thisHero.currentShieldPoints / (float)thisHero.maxShieldPoints;// thisHero.shield;
		HPSlider.sliderValue = thisHero.currentHitPoints / (float)thisHero.maxHitPoints;
	}
	#endregion
}
